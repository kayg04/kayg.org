...
I use [Proxmox SDN and a eVPN Zone](<./evpn-vxlan-proxmox-sdn.md>) as my main network [which means the default MTU is 1450](https://pve.proxmox.com/pve-docs/chapter-pvesdn.html#pvesdn_zone_plugin_evpn).

![proxmox-sdn-evpn-zone](<./docker-mtu-proxmox-sdn/proxmox-sdn-evpn-zone.png>)
...
This is problematic because now certain websites are inaccessible (see: [comments on my website](./bridge-mtu-proxmox]]) but moreso because it breaks [[../updates/comments) for users of GitHub and Microsoft. And I am a GitHub user! 
## The Solution
