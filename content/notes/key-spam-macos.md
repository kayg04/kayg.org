...
## ❓ What?
  ...
  MacOS has this behaviour where if you hold a key, such as in my case, holding `k` to move up in VSCode, a special character popup appears where you can choose an alternative character for the key pressed.
   ...
   ![[./key-spam-macos/enable-key-spam-or-disable-special-characters-on-macos-1.mp4]]
## 🎤 The fix
...
Run the command in your terminal app of choice, close/reopen app or logout/login or simply reboot. Since [[./key-spam-macos/enable-key-spam-or-disable-special-characters-on-macos-2.png|I am an uptime masochist]], I simply close and reopen apps.
