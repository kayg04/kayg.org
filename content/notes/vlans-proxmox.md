...
> 
> ![[./vlans-proxmox/VLANs in Proxmox-B21896F57E97A7D9BAD827424260BB60.jpg]]
> 
> So if you're coming from there, welcome! Here's the [[./vlans-proxmox/VLANs in Proxmox-2DC7941B54089F62B4AEF786965BDB56.pdf|Presentation PDF]] too if you missed it. The line "*Finally, allow communication within VLANs*" on Page 16 is **incorrect**; communication within a VLAN is permitted by default.
...
1. Visit the Network tab under the node and create a Linux bridge:
	![[./vlans-proxmox/VLANs in Proxmox-B1E5114A69115E413CC5C93A6D5974C9.png]]
        
2. Tick the “VLAN Aware” box.
	![[./vlans-proxmox/VLANs in Proxmox-69800FC1FB4DE08F4E901B0DFBDFBD72.png]]
...
3. Create a “Linux VLAN” too as we want the Proxmox Host to do the routing. Here we want to define a subnet as the VM will be permitted to set an IP within this subnet.
	![[./vlans-proxmox/VLANs in Proxmox-A02EC4C335EBF04839EC73F003A679B9.png]]
4. On the VM, goto the Hardware Tab. While creating the network device or editing a network device, add the vlan tag.
	![[./vlans-proxmox/VLANs in Proxmox-9B114AAAB7AFBB695294488B00E59A6B.png]]
        
5. Under VM → Cloud-init, add IPs belonging the VLAN’s subnet to the VMs.
    ![[./vlans-proxmox/VLANs in Proxmox-FEBA052B496066D6A4D9DF952E586B04.png]]
        
	![[./vlans-proxmox/VLANs in Proxmox-3910BD626ACCFE5DFF255D66F256F2F4.png]]
        
	Make sure to click on “Regenerate Image” to apply changes.
        
6. Start both VMs and get them to ping each other.
	![[./vlans-proxmox/VLANs in Proxmox-C71BF1EE0E7C1C386D779562BAC07531.png]]
...
1. Create a Linux Bridge under System → Network that refers to a VLAN on the NIC:
	![[./vlans-proxmox/VLANs in Proxmox-EB1839A6EF9B2B45245CECAB17CE2909.png]]
...
2. Use the bridge `vmbr2` on two test VMs to put them in the same VLAN. The VLAN tag on the VM itself is empty because the VM network device does not know it belongs to a VLAN, the bridge itself does.
	![[./vlans-proxmox/VLANs in Proxmox-0C354A5A599BC7404A7986907F0AAB7E.png]]
        
3. Under VM → Cloud-init, make sure the VM has an IP that belongs to our VLAN bridge:
	![[./vlans-proxmox/VLANs in Proxmox-33F0D3F919B13F32B5D8B864473346F1.png]]
        
	![[./vlans-proxmox/VLANs in Proxmox-C31CBF45E611534988105CBBF5298020.png]]
        
	Make sure to click on “Regenerate Image” for changes to apply to the VM.
        
4. Start the VMs and try to ping each other.
	![[./vlans-proxmox/VLANs in Proxmox-6647A103853A40C3D3117FC01D38E056.png]]
...
![[./vlans-proxmox/VLANs in Proxmox-86538024D1EDF2051ACE639E0687A864.png]]
