...
Of course, this can also be toggled globally with a `defaults` command, like when enabling [[Enable Key Spam or Disable Special Characters on MacOS|key spam]].
## 👓 References
